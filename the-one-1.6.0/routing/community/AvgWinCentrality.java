...
public class AvgWinCentrality implements Centrality {
    ...
    public AvgWinCentrality(Settings s) {
    ...
    public AvgWinCentrality(AvgWinCentrality proto) {
    ...
    public Centrality replicate() {
        return new AvgWinCentrality(this);
    }
